...
$taskOut = Join-Path $taskRoot 'artifacts\jev-parallel-p1\jev-parallel-p1-20260920-v1'
...
$expectedBuild = 'e96b12fed08428c1e9de55c01e98951dc8edee9d79411e135b8fe70d956407cc'
...
Write-Output "P1 H1.2 debug ready at http://127.0.0.1:8876/ PID $owner"
